...
const CreatePodcast = () => {
  ...
  return (
    <section className="mt-10 flex flex-col">
      <h1 className="text-xl font-bold text-white-1">Create Podcasts</h1>
        ...
        >
          <div className="flex flex-col gap-[30px] border-b border-black-5 pb-10">
            ...
            <div className="flex flex-col gap-2.5">
              <Label className="text-16 font-bold text-white-1">
                Select AI Voice of your choice
              </Label>
              <Select onValueChange={(value) => setVoiceType(value)}>
                ...
                <SelectContent
                  className="text-16 border-none
                 bg-black-1 font-bold text-white-1 focus:ring-orange-1"
                >
                  {voiceCategorys.map((category) => (
                    <SelectItem
                      key={category}
                      value={category}
          ...
          <div className="flex flex-col pt-10">
            ...
            <div className="mt-10 w-full ">
              <Button
                type="submit"
                className="text-16 w-full bg-orange-1 py-4 font-extrabold text-white-1 hover:bg-black-1 
